...
## More complex usage
See [example](https://github.com/gabrielzerbib/asseteer/blob/master/examples/composer.json) for more a more complex scenario (download font files for different repositories, and copy them together under the same parent css public folder).
